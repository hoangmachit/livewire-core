<section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
    <div class="container">
        <p class="text-center">
            <a href="{{ route('admin.index') }}" wire:navigate class="d-flex align-items-center justify-content-center">
            ...
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    <div class="text-center text-md-center mb-4 mt-md-0">
                        <h1 class="mb-0 h3">{{ __('admin.register.title') }}</h1>
                    </div>
                    <form action="#" class="mt-4">
                        <div class="form-group mb-4">
                            <label for="email">{{ __('admin.register.email') }}</label>
                        ...
                        <div class="form-group">
                            <div class="form-group mb-4">
                                <label for="password">{{ __('admin.register.password') }}</label>
                                <div class="input-group">
                            ...
                            <div class="form-group mb-4">
                                <label for="confirm_password">{{ __('admin.register.confirm_password') }}</label>
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon2">
                                        <svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">

<section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
    <div class="container">
        ...
        <div class="row justify-content-center form-bg-image"
            data-background-lg="{{ asset('assets/admin/image/illustrations/signin.svg') }}">
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    <div class="text-center text-md-center mb-4 mt-md-0">
                        <h1 class="mb-0 h3">{{ __('admin.login.title') }}</h1>
                    </div>
                    <form wire:submit='login' class="mt-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" wire:model="username" autocomplete="off"
                                    class="form-control @error('username') is-invalid @endif" id="username" />
                                @error('username')
                        ...
                        <div class="form-group">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="password" type="password" placeholder="******"
                                            autocomplete="off"
                                            class="form-control @error('password') is-invalid @endif" id="password" />
                                    @error('password')
                                        <span class="invalid-feedback"> {{ $message }} </span>
                                    @enderror
                                </div>
                            ...
                            <div class="d-flex
                                            justify-content-between align-items-top mb-4">
                                        ...
                                        <div>
                                            <a href="{{ route('admin.forgot_password') }}" wire:navigate
                                                class="small text-right">{{ __('admin.login.lost_password') }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-grid">
                    ...
                    <div class="mt-3 mb-4 text-center">
                        <span class="fw-normal">{{ __('admin.login.login_or_with') }}</span>
                    </div>
                    <div class="d-flex justify-content-center my-4">
                        <button disabled class="btn btn-icon-only btn-pill btn-outline-gray-500 me-2"
                        ...
                        <button disabled class="btn btn-icon-only btn-pill btn-outline-gray-500"

<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        <div
            ...
            <div class="d-flex align-items-center">
                <div class="avatar-lg me-4">
                    <img src="{{ asset('assets/admin/image/team/profile-picture-3.jpg') }}"
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="{{ route('admin.index') }}" wire:navigate class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ asset('assets/admin/image/brand/light.svg') }}" height="20" width="20"
                            alt="Volt Logo" />
                    </span>
                    <span class="mt-1 ms-1 sidebar-text">Livewire</span>
                </a>
            </li>
            ...
            <li class="nav-item {{ nav_active('product', 'active') }}">
                ...
                <div class="multi-level collapse {{ nav_active('product', 'show') }}" role="list" id="submenu-pages"
                    aria-expanded="false">
